    ...
    <div className="mx-auto flex min-h-screen max-w-md flex-col bg-background">
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/95 px-4 py-2.5 backdrop-blur">
       <div className="flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2" aria-label="PullBid Live home">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link to="/profile" aria-label={t("nav.profile")} className="flex h-8 w-8 items-center justify-center rounded-full bg-muted text-xs font-semibold">
