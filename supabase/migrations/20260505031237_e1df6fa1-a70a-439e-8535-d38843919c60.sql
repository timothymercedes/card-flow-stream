-- Create an order for a giveaway winner so the host can ship it from My Store
...
BEGIN
  ...
  -- Idempotent: if an order already exists for this giveaway, return it
  ...
  INSERT INTO orders (
    ...
    stream_id, status, payment_status, paid_at,
